...
<body>
    ...
    <div class="dropdown d-flex justify-content-end">
        <?php if ($isLoggedIn): ?>
            <button class="btn btn-secondary d-flex align-items-center p-3 rounded-0" type="button"
                ...
                <?php elseif ($isUser): ?>
                    <i class="fas fa-user me-2"></i> <?php echo $_SESSION['user']['first_name']; ?>
                <?php endif; ?>
            </button>
    ...
    <!-- Asegúrate de incluir las bibliotecas de Bootstrap y Font Awesome -->
    <!-- Aquí se utiliza Font Awesome para los íconos -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/js/all.min.js"></script>
    <!-- Bootstrap JS -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-pzjw8f+ua/C5K0H8g9Ru8szQ4S1fp6wkg3G5Hj8Fg0PkIi4qFqF/PQ2tcXgOkI5L" crossorigin="anonymous"></script>
</body>
